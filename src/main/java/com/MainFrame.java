...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        removeByTitleButton.addActionListener(_ -> navigateToRemoveByTitlePage());
        checkOutButton.addActionListener(_ -> navigateToCheckOutPage());
        checkInButton.addActionListener(_ -> navigateToCheckInPage());
        displayButton.addActionListener(_ -> navigateToDisplayDatabasePage());
        exitButton.addActionListener(_ -> confirmExit());
    }
